...
from data.uck_cxr_dm import UCKCXRDataModule
...
class UckCtrSegTrainingObject(CommonTrainingObject):
    ...
    def _setup_data_module(self) -> UCKCXRDataModule:

        data_module = UCKCXRDataModule(self.cfg)
...
def train(cfg: DictConfig):
    ...
    training_obj = UckCtrSegTrainingObject(
